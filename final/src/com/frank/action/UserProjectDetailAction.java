 ...
 * 
 */
public class UserProjectDetailAction extends ActionSupport {
	private String name;
	...
	@Action(value = "userProjectDetail", results = {
			@Result(name = ERROR, location = "/show/error.jsp"),
			@Result(name = SUCCESS, location = "/user/userProjectDetails.jsp") })
